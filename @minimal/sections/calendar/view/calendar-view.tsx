...
// _mock
import { CALENDAR_COLOR_OPTIONS } from '@minimal/_mock/_calendar';
// api
import { useGetEvents, updateEvent } from '@minimal/api/calendar';
// components
import Iconify from '@minimal/components/iconify';
import { useSettingsContext } from '@minimal/components/settings';
// types
import { ICalendarFilters, ICalendarFilterValue, ICalendarEvent } from '@minimal/types/calendar';
//
