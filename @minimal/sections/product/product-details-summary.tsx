...
// utils
import { fShortenNumber, fCurrency } from '@minimal/utils/format-number';
// components
import Label from '@minimal/components/label';
import Iconify from '@minimal/components/iconify';
import { ColorPicker } from '@minimal/components/color-utils';
import FormProvider, { RHFSelect } from '@minimal/components/hook-form';
// types
import { IProductItem } from '@minimal/types/product';
