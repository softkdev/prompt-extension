...
// hooks
import { useLocalStorage } from '@minimal/hooks/use-local-storage';
// routes
import { paths } from '@minimal/routes/paths';
import { useRouter } from '@minimal/routes/hook';
// _mock
import { PRODUCT_CHECKOUT_STEPS } from '@minimal/_mock/_product';
// types
import { IAddressItem } from '@minimal/types/address';
import { ICheckoutValue, ICheckoutItem } from '@minimal/types/checkout';
//
