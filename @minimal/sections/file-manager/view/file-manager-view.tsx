...
// _mock
import { _allFiles, FILE_TYPE_OPTIONS } from '@minimal/_mock';
// hooks
import { useBoolean } from '@minimal/hooks/use-boolean';
// components
import Iconify from '@minimal/components/iconify';
import EmptyContent from '@minimal/components/empty-content';
import { fileFormat } from '@minimal/components/file-thumbnail';
import { ConfirmDialog } from '@minimal/components/custom-dialog';
import { useSettingsContext } from '@minimal/components/settings';
import { useTable, getComparator } from '@minimal/components/table';
// types
import { IFile, IFileFilters, IFileFilterValue } from '@minimal/types/file';
//
