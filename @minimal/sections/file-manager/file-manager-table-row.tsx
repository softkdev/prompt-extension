...
import { useDoubleClick } from '@minimal/hooks/use-double-click';
import { useCopyToClipboard } from '@minimal/hooks/use-copy-to-clipboard';
// utils
import { fData } from '@minimal/utils/format-number';
// types
import { IFileManager } from '@minimal/types/file';
// components
