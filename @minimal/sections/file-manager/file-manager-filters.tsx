...
// types
import { IFileFilters, IFileFilterValue } from '@minimal/types/file';
// components
...
import CustomDateRangePicker, { shortDateLabel } from '@minimal/components/custom-date-range-picker';
